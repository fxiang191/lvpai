...
export default {
  data(){
    return {
      ...
      imgs:[
        {
          src:"/images/carousel_item/1a24c431e6956c7d8598fc7003d59b72.png",
          title:"《Ghost Mane》| STARR J与恶魔一起住在Dark Castle",
          to:"javascript:;"
        },
        { 
          src:"/images/carousel_item/4db987a82a529f5b41303d1b92d6b0ee.jpg",
          title:"赐我们一首比“情歌而已”更值得唱的歌 声音碎片第三支预热单曲《送流水》首发",
          to:"javascript:;"
        },
        { 
          src:"/images/carousel_item/45778d98934df7f6cf167baac8cac674.png",
          title:"我眼里只有一个3号他永远昂着头 | 黄旭全新单曲《低位》致敬韦德",
          to:"javascript:;"
        },
        { 
          src:"/images/carousel_item/ed1a016d794202aae12ed33f80084fa3.jpg",
